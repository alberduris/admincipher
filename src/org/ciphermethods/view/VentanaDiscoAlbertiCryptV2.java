...
public class VentanaDiscoAlbertiCryptV2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaDiscoAlbertiCryptV2 frame = new VentanaDiscoAlbertiCryptV2();
	 ...
	 * Create the frame.
	 */
	public VentanaDiscoAlbertiCryptV2() {
		dA = new DiscoAlberti();
